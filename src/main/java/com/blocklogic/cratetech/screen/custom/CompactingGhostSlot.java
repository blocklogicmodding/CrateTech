...
public class CompactingGhostSlot extends Slot {
    private final CompactingGhostItemHandler ghostHandler;
    private final int slotIndex;

    public CompactingGhostSlot(CompactingGhostItemHandler itemHandler, int index, int xPosition, int yPosition) {
